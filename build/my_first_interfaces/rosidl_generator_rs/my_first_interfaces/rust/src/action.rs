...
#[link(name = "my_first_interfaces__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_action_type_support_handle__my_first_interfaces__action__Fibonacci() -> *const std::ffi::c_void;
}

// Corresponds to my_first_interfaces__action__Fibonacci
#[allow(missing_docs, non_camel_case_types)]
...
impl rosidl_runtime_rs::Action for Fibonacci {
  ...
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_action_type_support_handle__my_first_interfaces__action__Fibonacci() }
  }
